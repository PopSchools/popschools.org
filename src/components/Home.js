     ...
     <div className=" px-3 py-16 ">
       ...
       <div>
        ...
        <div className=" mb-8 bgpro">
            <div className="container">
            <p className="text-gray-600 md:px-32 text-4xl font-bold text-center py-2">PopSchools is meant to create access to a safe and inclusive community, mutual aid, and paying work opportunities through apprenticeships to early-career software developer</p>
...
<div className="bg-gray-900" id="about" >
    ...
    <div className="py-24">
            <img src={bak}  className="px-4 w-32 h-32 md:mr-18"/>
            <p className="px-24 text-gray-200 text-xl py-2 prose ">
 ...
 <p className=" text-center text-2xl font-extrabold text-gray-600">Meet our Founder</p>
     ...
     <div className="grid md:grid-cols-2">
         ...
         <img src={about} className=" w-full rounded-lg shadow border-4 border-gray-600 " />
         </div>
         <div>
...
<a href=""><span className="px-3 text-gray-600 text-2xl inline-block"><TwitterCircleFilled /></span></a>
        ...
        {/* Sponsors */}
        <div className=" py-8 bg-gray-800" id="sponsors">
          <div className="container">
          <p className=" text-center text-4xl font-extrabold text-gray-100">Our Sponsors</p>
           <center><hr className="w-48"/></center> 
          </div>
  <div uk-slider="center: true" >
    ...
    <div className="uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
       ...
       <ul className="uk-slider-items uk-child-width-1-5@s uk-grid">
         ...
         <a className="uk-position-center-left uk-position-small uk-hidden-hover bg-gray-600 text-white font-bold rounded-full shadow h-8 w-8 px-3 " href="#"  uk-slider-item="previous"><LeftOutlined /></a>
         <a className="uk-position-center-right uk-position-small uk-hidden-hover bg-gray-600 text-white font-bold rounded-full shadow h-8 w-8 px-3" href="#" uk-slider-item="next"><RightOutlined /></a>
     </div>
      ...
      <ul className="uk-slider-nav uk-dotnav uk-flex-center uk-margin"></ul>
        ...
        <p className=" text-center text-2xl font-extrabold text-gray-700">Contributors</p>
        <center><hr className="w-48"/></center> 
              ...
              {/* card==for contact */}
                <div className="bg-white rounded-md">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <div className="py-4">
                            <img src={about} className=" ml-8 md:ml-8   w-10 h-10 rounded-full shadow border-4 border-gray-600 " />
                            </div>
